...
export default function Services() {
  return (
    <section id="services" style={{ padding: "56px 28px", background: "#fff", borderTop: "0.5px solid #D8D6EE" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <h2 style={{ fontSize: 22, fontWeight: 500, color: "#1A1540", marginBottom: 28 }}>Everything you need to launch and grow online.</h2>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 10 }}>
          {services.map(({ icon: Icon, title, desc }) => (
            <div key={title} style={{ background: "#F0EFF8", border: "0.5px solid #D8D6EE", borderRadius: 10, padding: "16px 18px" }}>
              <Icon size={20} color="#3D2E8F" style={{ marginBottom: 10 }} />
              <p style={{ fontSize: 13, fontWeight: 500, color: "#1A1540", marginBottom: 4 }}>{title}</p>
